...
struct CurrencyFormatter {
    ...
    // Converts 929466.23 -> "929,466" and "23"
    ...
    private func convertDollar(_ dollarPart: Double) -> String {
        ...
        let dollarComponents = dollarsWithDecimal.components(separatedBy: decimalSeparator) // "$929,466" and "00"
    ...
    private func makeBalanceAttributed(dollars: String, cents: String) -> NSMutableAttributedString {
        ...
        let dollarAtributes: [NSAttributedString.Key: Any] = [.font: UIFont.preferredFont(forTextStyle: .title1)]
        ...
        let dollarString = NSAttributedString(string: dollars, attributes: dollarAtributes)
